...
const BorderGlow = ({
  ...
  const updatePointerGlow = useCallback(() => {
    ...
    // Read layout once per animation frame. The previous implementation read
    // the same rectangle three times for every raw pointer event.
  ...
  return (
    <div
      ...
      style={{
        ...
        '--border-intensity': glowIntensity,
